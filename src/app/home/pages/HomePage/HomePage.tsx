    ...
    <>
      ...
      <div className="mt-10">
        <div className="flex items-center justify-center mb-10 gap-10">
          ...
          <Link href="https://mentoor.io" newTab>
            <img
        ...
        <h1 className="text-center">
          <div className="my-2">
            <span className="text-4xl font-bold">Powered By</span>
            <div className="block mt-2">
              <PrimaryLink newTab href="https://github.com/hassanzohdy">
                Mongez Ecosystem
              </PrimaryLink>
            </div>
          </div>
        </h1>
        <div className="flex gap-2 my-4 items-center flex-col justify-center">
          <UpdateCounterButton />
          <DisplayCounter />
        </div>
        ...
        <div className="text-center">
          <small>
            This component will be the only component that will be rendered{" "}
            <br /> when the counter button is clicked. <br />
